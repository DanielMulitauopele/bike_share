...
describe 'visitor sees all stations' do
  describe 'they visit stations index' do
    before(:each) do
      @station1 = Station.create(name: 'Wash Park East', dock_count: 10, city: 'Denver', installation_date: '2018-09-01', slug: 'WashParkEast')
      @station2 = Station.create(name: 'Yale St', dock_count: 5, city: 'Englewood', installation_date: '2018-09-02', slug: 'YaleSt')
    end
