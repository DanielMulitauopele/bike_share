...
describe 'when user clicks on checkout an order is submitted' do
  describe 'user will be redirect to their dashboard' do
    describe 'they link from the carts page' do
      ...
      it 'should clear cart when user presses checkout' do
        accessory_1 = create(:accessory)
        accessory_2 = create(:accessory, title: 'an accessory')
        accessory_3 = create(:accessory, title: 'an accessory again')
        user = create(:user)
