...
describe 'visit the trips-dashboard-path' do
  context 'as a registered user' do
    	...
    	@trip_2 = Trip.create!(duration: 200, start_date:	'2013-01-09 04:06:00', start_station_id:	1	, end_date: '2013-01-09 15:08:00',
      	                    end_station_id: 2, bike_id: 30, subscription_type:	'customer', zip_code:	94063)
    	@trip_3 = Trip.create!(duration: 100, start_date:	'2013-01-09 10:41:00', start_station_id:	2	, end_date: '2013-01-09 11:24:00',
                            end_station_id: 2, bike_id: 30, subscription_type:	'customer', zip_code:	94063)
    	@trip_4 = Trip.create!(duration: 200, start_date:	'2013-01-09 11:30:00', start_station_id:	3	, end_date: '2013-01-09 11:51:00',
